...
const functionalRoles = [
  ...
  },
  {
    ...
    description: 'Gerencia uma ou mais squads e garante a entrega de projetos com qualidade.',
    responsibilities: [
      'Gerenciar uma ou mais squads',
      'Garantir a entrega de projetos no prazo e com qualidade',
      'Desenvolver e mentorizar membros da equipe',
      'Gerir conflitos e promover a colaboração dentro da equipe',
    ],
    pair: null,
  },
  {
    id: 'tl',
    name: 'Tech Lead (TL)',
    description: 'Lidera tecnicamente uma squad e garante a qualidade das entregas.',
    responsibilities: [
      'Liderar tecnicamente uma squad',
      'Garantir a qualidade e eficiência técnica das entregas',
      'Definir a arquitetura e padrões técnicos dos projetos',
      'Acompanhar métricas das aplicações de domínio do time (performance, erros, etc)',
      'Conduzir cerimônias de refinamento',
      'Construir/desenvolver funcionalidades de grande complexidade quando for necessário',
      'Ajudar pessoas do time que estiverem com Pull Requests em atraso, ou estiverem com dificuldade',
      'Tomar decisões técnicas de menor criticidade dentro da squad',
    ],
    pair: null,
  },
]
