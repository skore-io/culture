...
const functionalRoles = [
  ...
  {
    id: 'tm',
    name: 'Tech Manager (TM)',
    description:
      'Gestor de squad que equilibra liderança e responsabilidades técnicas, assegurando a qualidade e entrega dos projetos.',
    responsibilities: [
      'Orientar e coordenar squads para garantir que estejam focados nos objetivos da empresa e operem de forma eficaz.',
      'Supervisionar e assegurar que os projetos sejam entregues dentro dos prazos estabelecidos e com alta qualidade.',
      'Proporcionar orientação contínua, feedbacks e oportunidades de desenvolvimento profissional para os membros da equipe.',
      'Fomentar um ambiente de trabalho positivo, facilitando a colaboração e solucionando conflitos.',
      'Estabelecer metas claras e acompanhar o desempenho da equipe para garantir que os objetivos estratégicos sejam alcançados.',
      'Servir como ponto de contato entre a equipe e outras partes interessadas, garantindo uma comunicação fluida.',
      'Reter talentos na equipe, promovendo um ambiente de trabalho positivo e desafiador.',
      'Participar ativamente do hunting de novos talentos para preencher vagas e fortalecer a equipe.',
      'Promover a adoção e aprendizado das melhores tecnologias e práticas para melhorar continuamente os processos e produtos.',
