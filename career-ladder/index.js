...
const functionalRoles = [
  ...
  {
    id: 'ems',
    name: 'Engineering Manager Senior (EMS)',
    description: 'Lidera múltiplos Engineering Managers e define estratégias de longo prazo.',
    responsibilities: [
      'Liderar múltiplos Engineering Managers',
      'Definir estratégias de médio a longo prazo',
      'Garantir a execução de iniciativas críticas',
      'Garantir a integração entre diferentes squads',
      'Desenvolver líderes e promover a cultura de inovação',
    ],
    pair: 'ttl',
  },
  {
    ...
    description: 'Gestor que lidera squads, garante a entrega de projetos com qualidade e prazo, desenvolve a equipe e promove a colaboração e inovação.',
    responsibilities: [
      'Gerenciar uma ou mais squads, assegurando que cada equipe esteja alinhada com os objetivos da organização e funcione de maneira eficiente',
      'Garantir a entrega de projetos no prazo e com qualidade, supervisionando o progresso das iniciativas e implementando estratégias para cumprir os prazos e manter os padrões de excelência',
      'Desenvolver e mentorizar membros da equipe, oferecendo orientação, feedback e oportunidades de crescimento profissional para promover o desenvolvimento contínuo dos colaboradores',
      'Gerir conflitos e promover a colaboração dentro da equipe, resolvendo desacordos de forma eficaz e incentivando um ambiente de trabalho cooperativo e harmonioso',
      'Definir e acompanhar metas e KPIs da equipe, estabelecendo objetivos claros e medindo o desempenho para garantir o alinhamento com as metas estratégicas da empresa',
      'Implementar e manter processos de desenvolvimento ágil, garantindo que as práticas de metodologia ágil sejam seguidas para otimizar a eficiência e a entrega contínua de valor',
      'Facilitar a comunicação entre a equipe e outras partes interessadas, atuando como um elo entre a equipe técnica e outras áreas da empresa, como produto, marketing e operações',
      'Promover a inovação e a melhoria contínua, incentivando a equipe a buscar novas tecnologias e práticas para melhorar processos e produtos',
      'Liderar esforços de recrutamento e retenção, participando ativamente na seleção de novos talentos e implementando estratégias para manter os membros da equipe engajados e satisfeitos',
      'Fomentar a diversidade e inclusão na equipe, promovendo um ambiente de trabalho inclusivo e respeitoso que valorize diferentes perspectivas e experiências'
    ],
    pair: null,
  },
  {
    id: 'tl',
    name: 'Tech Lead (TL)',
    description: 'Desenvolvedor que garante a qualidade técnica das entregas, soluciona problemas complexos, monitora métricas, atua em incidentes e assegura a conformidade com as políticas de segurança.',
    responsibilities: [
  ...
  function renderRaciTable() {
    ...
    raciData.forEach((item) => {
      ...
      row.innerHTML = `
        ...
        <td><span class="raci-cell raci-${item.EMS.toLowerCase()}" data-original-color="${getColor(item.EMS)}">${item.EMS}</span></td>
